...
namespace University.API.Controllers
{
...

    {
        ...
        /// <response code="200">ok, devuelve el objeto la validacion del modelo</response>
        /// <response code="400">BadRequest no se cumple con la validacion del modelo</response>
        /// <response code="500">InterlServerError, Se ha presentado un error</response>
        [HttpPost]
        ...
        public async Task<IHttpActionResult> Delete(int id )
        {
            try
            {
                ...
                //if (context.Enrollment.Any(x => x.StudentID == id))
                   // throw new Exception("Dependencias");
